...
<!--        <a id="addMoviePlusBtn" data-link href="/add-a-movie" target="_blank">+</a>-->
    ...
    <div class="card col-3">
        <div class="cardBody">
            <p>${movie.title}</p>
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editMovieModal"><i class="fa fa-pencil"></i></button>
              ...
              <div class="modal-body">
                <div class="container text-center">
                    ...
                    <form>
                        ...
                        <input class="form-control text-center" list="datalistOptions" id="editMovieTitle" placeholder="Enter new movie title">
                        <label for="editMovieDirector" class="form-label">Director:</label>
                        <input class="form-control text-center" list="datalistOptions" id="editMovieDirector" placeholder="Enter the Director's name">
                        <label for="editMovieRating" class="form-label">Rating:</label>
                        <input class="form-control text-center" list="datalistOptions" id="editMovieRating" placeholder="Enter a movie rating 0-5">
                    </form>
