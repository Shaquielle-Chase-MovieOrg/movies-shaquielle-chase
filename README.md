...
2. Create a Github organization and create a repository to put your code in there.
3. Use your own remixed URL to `fetch` results inside of your project to perform RESTful API requests, it should look like: `https://your-random-url.glitch.me/movies`.
4. Keep it in mind that the `json-server` doesn't update in real-time the `db.json` file, but it does respond with the latest information. Always rely on the endpoint that looks like this [https://codeup-json-server.glitch.me/movies](https://codeup-json-server.glitch.me/movies)

 ## OUR ENDPOINT: https://glory-cedar-barge.glitch.me/movies
